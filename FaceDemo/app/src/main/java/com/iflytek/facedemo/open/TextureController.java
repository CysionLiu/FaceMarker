...
import com.iflytek.facedemo.filter.AFilter;
import com.iflytek.facedemo.filter.GroupFilter;
import com.iflytek.facedemo.filter.NoFilter;
import com.iflytek.facedemo.utils.EasyGlUtils;
import com.iflytek.facedemo.utils.MatrixUtils;
...
public class TextureController implements GLSurfaceView.Renderer {
    ...
    private GLSurfaceView.Renderer mRenderer;                                 //用户附加的Renderer或用来监听Renderer
